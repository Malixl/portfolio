...
import { FiGithub, FiLinkedin, FiInstagram, FiArrowRight, FiChevronDown } from 'react-icons/fi'
        ...
        >
          ...
          <div className="flex flex-col items-center gap-8 mt-12">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="px-8 py-4 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-bold text-lg flex items-center gap-2 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 active:scale-95"
            >
              View CV ATS <FiArrowRight size={20} />
            </a>

            <div className="flex items-center gap-6">
              {links.github && (
                <a href={links.github} target="_blank" rel="noreferrer" className={socialButton}>
                  <FiGithub size={20} />
                </a>
              )}
              {links.linkedin && (
                <a href={links.linkedin} target="_blank" rel="noreferrer" className={socialButton}>
                  <FiLinkedin size={20} />
                </a>
              )}
              {links.instagram && (
                <a href={links.instagram} target="_blank" rel="noreferrer" className={socialButton}>
                  <FiInstagram size={20} />
                </a>
              )}
              {links.behance && (
                <a href={links.behance} target="_blank" rel="noreferrer" className={socialButton}>
                  <FaBehance size={20} />
                </a>
              )}
            </div>
